...
func (app *application) orderCreatePost(w http.ResponseWriter, r *http.Request) {
	...
	id, err := app.orders.Insert(form.Title, form.Content, form.Expires)
	if err != nil {
		app.serverError(w, r, err)
		return
	}

	app.sessionManager.Put(r.Context(), "flash", "Order succesfully created!")
...
func (app *application) userLoginPost(w http.ResponseWriter, r *http.Request) {
	...
	http.Redirect(w, r, "/order/create", http.StatusSeeOther)
}
